 ...
 *
 * <p>Purpose: remaps chest atlas sprites through Cinder's OptiFine Random
    ...
    @ModifyExpressionValue(method = "submit",
            at = @At(value = "INVOKE",
                    target = "Lnet/minecraft/client/renderer/Sheets;"
                            ...
                            + "sprite/SpriteId;"),
            require = 0)
    private SpriteId cinder$randomChestSprite(
            SpriteId original,
        ...
        return RandomEntityRuntime.remapSprite(original,
                cinderState.cinder$getRandomEntityContext(), true);
    }
}
