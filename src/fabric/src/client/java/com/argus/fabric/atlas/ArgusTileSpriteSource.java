package com.argus.fabric.atlas;
...
import com.argus.ctm.CtmProperties;
import com.argus.ctm.CtmMethod;
import com.argus.ctm.CtmRule;
import com.argus.ctm.CtmTileSpec;
import com.argus.ctm.CtmTileResolver;
import com.argus.ctm.TileIndexTable;
 ...
 * reload.
 */
public record ArgusTileSpriteSource() implements SpriteSource {
     ...
     */
    public static final MapCodec<ArgusTileSpriteSource> MAP_CODEC =
            MapCodec.unit(ArgusTileSpriteSource::new);
    ...
    @Override
    public MapCodec<ArgusTileSpriteSource> codec() {
        return MAP_CODEC;
    }
