...
public interface Platform {
    ...
    /**
     * The mod id under which the running instance of Argus is registered.
     *
     * <p>For Phase 0 this is always {@code "argus"} (see
     * {@code gradle.properties} -> {@code mod_id=argus}). The method exists
     ...
     * need to null-check.
     */
    com.argus.ctm.CtmRegistry ctmRegistry();
}
