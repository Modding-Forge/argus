 ...
 * effective rules from the current {@link ArgusConfig}; this keeps Sodium menu
...
public final class BetterGrassRules {
    ...
    private static final AtomicReference<BetterGrassRules> PACK_RULES =
            new AtomicReference<>();
    private static volatile ArgusConfig cachedConfig;
     ...
     */
    public static BetterGrassRules current(ArgusConfig config) {
    ...
    /**
     * Builds the no-resource-pack fallback from Argus's config toggles.
     */
    public static BetterGrassRules fromConfig(ArgusConfig config) {
