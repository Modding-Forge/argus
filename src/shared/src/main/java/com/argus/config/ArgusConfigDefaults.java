...
/**
 * Default values for the {@link ArgusConfig}. The defaults
 ...
 */
public final class ArgusConfigDefaults {
    ...
    private ArgusConfigDefaults() {
    }

    /**
     * Returns the default configuration. Used by
     * {@link ArgusConfigLoader} when the file is missing or
     * when a key has no explicit value.
     */
    public static ArgusConfig defaults() {
        return new ArgusConfig(ENABLED, SAFE_MODE, VERIFY_MODE, CTM_ENABLED,
