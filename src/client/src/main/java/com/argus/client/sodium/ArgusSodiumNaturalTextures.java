...
import com.argus.client.natural.NaturalTexturesRuntime;
import com.argus.natural.NaturalTextureRule;
 ...
 */
public final class ArgusSodiumNaturalTextures {
    ...
    public boolean apply(MutableQuadViewImpl quad,
        ...
        if (!ArgusConfigHolder.get().naturalTexturesActive()) {
            return false;
        }
