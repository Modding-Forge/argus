 ...
 *
 * <p>Purpose: applies Argus Custom Colors to Sodium's cached grass, foliage,
 ...
 *
 * <p>Compatibility: gated by {@link ArgusClientMixinPlugin}; no vanilla
...
public abstract class SodiumLevelColorCacheCustomColorsMixin {
    ...
    @WrapOperation(
            ...
            at = @At(
                    ...
                    remap = true))
    private int argus$customBiomeColor(ColorResolver resolver,
                                        Biome biome,
                                        double x,
                                        double z,
