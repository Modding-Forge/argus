...
import com.argus.client.customcolors.ArgusCustomBlockTintSource;
...
public final class CtmSodiumOverlayTint {
    ...
    public int color(CtmRule rule,
        ...
        if (tintSource == ArgusCustomBlockTintSource.PALETTE
                && !ArgusCustomBlockTintSource.isVanillaTintedState(tintState)) {
            return -1;
        }
