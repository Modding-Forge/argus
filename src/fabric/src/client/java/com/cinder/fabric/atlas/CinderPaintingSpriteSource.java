 ...
 * resource lookups.
 */
public record CinderPaintingSpriteSource() implements SpriteSource {
    ...
    public static final MapCodec<CinderPaintingSpriteSource> MAP_CODEC =
            MapCodec.unit(CinderPaintingSpriteSource::new);
    ...
    @Override
    public MapCodec<CinderPaintingSpriteSource> codec() {
        return MAP_CODEC;
    }
