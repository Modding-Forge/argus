package com.argus.compat;

import java.util.List;

/**
 * Default list of mod ids that Argus probes for. The list is
 ...
 * Argus will at least <i>know</i> about it; the actual
...
public final class CompatDefaults {
    ...
    /**
     * Returns the list of mod ids that Argus probes for. The
