 ...
 * a stable, public, loader-agnostic interface. Argus
 ...
 * Argus's pipeline itself via the loader-side integration
 ...
 * who want to run before Argus pick a lower number, those
 ...
 * exactly one decorator (Argus's CTM one), so the overhead
